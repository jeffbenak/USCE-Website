...
const Slider = [
  {
    ...
    button: <Link to='/loginsign' className='click'>Click Here</Link>
  },
  {
    ...
    button: <Link to="/services" className='click'>Click Here</Link>
  },
  {
...
'></img>,
    ...
    button: <Link to='/' className='click'>Click Here</Link>
  },
  {
    image: "",
    title: "Slide Four",
