        ...
        <h3>SUMMARY OF SCHEDULE</h3>
          ...
          <div className='grid-container'>
            ...
            <div className='grid'>
              ...
              <div className='c-2'>TUESDAY</div>
              <div className='c-2-1'>9 AM - 2 PM New Lenox every other Tuesdays</div>


                {/* COLUMN 3 */}


              <div className='c-3'>WEDNESAY</div>
              <div className='c-3-1'>10 AM - 2 PM in Park Ridge</div>


                {/* COLUMN 4 */}


              <div className='c-4'>THURSDAY</div>
              <div className='c-4-1'>7:30 AM - 4/5 PM St Anthony Hospital</div>


                {/* COLUMN 5 */}


              <div className='c-5'>FRIDAY</div>
              <div className='c-5-1'>9 AM - 2 PM in St Anthony</div>
              <div className='c-5-2'>4 PM - 5/6 PM in Park Ridge</div>


                {/* COLUMN 6 */}


              <div className='c-6'>SATURDAY</div>
              <div className='c-6-1'>9:00 AM - 12:00 in Park Ridge</div>
              <div className='c-6-2'>1:00 PM -3/4 PM in St Anthony Hospital</div>
